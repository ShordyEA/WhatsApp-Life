...
## **🚀 ¡Pruébalo ahora mismo\! (Versión de Prueba)**
...
**⚠️ Nota de Responsabilidad:** Ningún software de automatización web es 100% inmune a baneos si se utiliza para hacer SPAM masivo a desconocidos. Se recomienda enviar mensajes a bases de datos de clientes y calentar los números nuevos antes de lanzar campañas.

## **⚙️ Guía de Uso Rápido (PC)**

Nuestra herramienta está pensada para ser *Plug & Play*:

1. **Descarga:** Baja el archivo .zip desde el enlace de arriba.  
2. **Descomprime:** Extrae la carpeta completa en tu escritorio o documentos.  
3. **Ejecuta:** Haz doble clic en el archivo ejecutable (WhatsApp Life.exe). ¡No necesitas instalar lenguajes de programación\!

### **Flujo de Trabajo**

1. **Configura el Navegador:** La primera vez que presiones "Iniciar Campaña", el sistema detectará o te pedirá la ruta del navegador incluido.  
2. **Carga tus Contactos:** Ve a la pestaña **Gestor Contactos**, haz clic en *Importar Excel* o añade contactos manualmente.  
3. **Diseña la Campaña:** Vuelve al **Panel Principal**. Selecciona a tus destinatarios, escribe tu mensaje y añade los adjuntos. Utiliza el botón \+ para añadir más mensajes en cadena.  
